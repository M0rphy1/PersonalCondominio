...
if(isset($_GET['buscar'])){
    ...
    $buscar = true;
    $sql = "SELECT p.codigo AS codigo_personal, p.cedula, p.nombre, p.apellido, m.codigo AS codigo_limpieza, m.nombrearea, m.sueldo FROM personal p LEFT JOIN mantenimiento m ON p.codigo = m.codigopersonal WHERE m.codigo='$codigo_personal' AND m.codigo IS NOT NULL";
}
...
<body>
    <center>
        ...
        <form method="GET" action="../modelo/buscarM.php">
