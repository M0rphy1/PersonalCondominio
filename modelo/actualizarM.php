...
<body>
    <center><h1>Actualizar datos de Personal de Código de Mantenimiento: <?php echo $codigo_mantenimiento; ?></h1></center>
</body>
</html>
...
$codigo_limpieza = $_GET['codigo_mantenimiento'];
...
while ($mostrar = mysqli_fetch_array($resultado)) {
    ...
    <body><center>
        <form action="../modelo/guardarM.php" method="post">
        <table border="1">
        <tr>
            <th>Código de Personal</th>
            <th>Código de Personal de Mantenimiento</th>
            <th>Cédula</th>
            <th>Nombre</th>
            <th>Apellido</th>
            ...
            <tr>
                ...
                <td><span><?php echo $mostrar['codigo_mantenimiento'] ?></span></td>
