...
if(isset($_POST['eliminar'])){
    ...
    $sql_mantenimiento = "DELETE FROM mantenimiento WHERE codigo='$codigo_mantenimiento'";

    // Ejecutar las consultas SQL
    if ($conexion->query($sql_personal) === TRUE && $conexion->query($sql_mantenimiento) === TRUE) {
