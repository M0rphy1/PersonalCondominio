...
if(mysqli_num_rows($resultado) > 0) {
    ...
    if($codigo_personal !== null) {
        // Insertamos los datos en la tabla limpieza con el código personal como clave foránea
        $sql_mantenimiento = "INSERT INTO mantenimiento (nombrearea, sueldo, codigopersonal) VALUES ('$nombrearea', '$sueldo', '$codigo_personal')";
