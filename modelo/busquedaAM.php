...
if(isset($_GET['buscar'])){
    ...
    $sql = "SELECT p.codigo AS codigo_mantenimiento, m.codigo AS codigo_mantenimiento, p.cedula, p.nombre, p.apellido, m.nombrearea, m.sueldo 
            FROM personal p 
    ...
    if ($result->num_rows > 0) {
        ...
        include("../modelo/actualizarM.php");
    } else {
